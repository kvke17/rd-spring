  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-28 pb-20">
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="w-20 h-20 bg-[#FF0000]/20 text-[#FF0000] rounded-full flex items-center justify-center mx-auto mb-8 text-4xl font-bold border border-[#FF0000]/50">✓</div>
        <p className="text-xs uppercase tracking-[0.25em] text-[#FF0000] font-mono mb-4">TRANSACCIÓN APROBADA</p>
        ...
        <div className="border border-white/10 bg-[#121212] p-8 text-left mb-8">
          ...
          <div className="grid grid-cols-2 gap-y-4 font-mono text-sm">
            ...
            <div className="text-[#FF0000] text-right font-bold pt-4 border-t border-white/10">{STORE_CONFIG.CURRENCY_FORMAT.format(amount)}</div>
          </div>
        </div>
