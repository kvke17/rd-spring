    ...
    <div className="min-h-screen bg-[#0a0a0a] text-white pt-28 pb-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 border-b border-white/10 pb-16">
          <div className="lg:col-span-7 border border-white/10 bg-[#121212] p-8 aspect-square relative flex items-center justify-center">
          ...
          <div className="lg:col-span-5 flex flex-col justify-between space-y-6">
            <div className="space-y-4">
              ...
              <div className="pt-6 border-t border-white/10">
                ...
                <p className="text-3xl font-bold font-mono text-white">{STORE_CONFIG.CURRENCY_FORMAT.format(product.price)}</p>
              ...
              <div className="pt-4">
                {product.type === 'cotizacion' ? (
                  ...
                  <div className="flex gap-3">
                    ...
                    <button onClick={() => addItem(product, quantity)} className="flex-1 bg-[#E88A5C] text-black font-bold py-4 text-xs uppercase tracking-widest hover:bg-opacity-90">AGREGAR AL CARRO</button>
                  </div>
                )}
              </div>
          ...
          <div className="md:col-span-8 space-y-6 font-mono">
            <div className="flex flex-wrap gap-3">
              {product.compatibility.map((gen) => (
                <span key={gen} className="bg-[#121212] border border-white/20 text-white px-4 py-2 text-xs">{gen}</span>
              ))}
            </div>
