    ...
    <footer className="bg-[#121212] border-t border-white/10 pt-16 pb-8">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12 mb-12">
          ...
          <div>
            <h4 className="text-[10px] uppercase tracking-widest text-[#E88A5C] font-mono mb-4">Repuestos</h4>
          ...
          <div>
            <h4 className="text-[10px] uppercase tracking-widest text-[#E88A5C] font-mono mb-4">Atención al Cliente</h4>
            <ul className="space-y-2 text-xs font-mono text-gray-400">
