...
const subtitle = { color: '#b3131b', fontSize: '12px', letterSpacing: '2px', textAlign: 'center' as const, marginTop: '4px' };
...
const receiptHeading = { color: '#b3131b', fontSize: '12px', fontWeight: 'bold', letterSpacing: '1px', marginBottom: '12px' };
