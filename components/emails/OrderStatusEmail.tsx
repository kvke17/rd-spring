...
// 1. Agregamos el nuevo estado a la línea de tiempo
      ...
      <Body style={main}>
        <Container style={container}>
          ...
          <Section style={card}>
            ...
            <Text style={text}>
              El estado de tu pedido <strong style={{ color: '#fff', fontFamily: 'monospace' }}>{buyOrder}</strong> ha sido actualizado a <strong style={{ color: '#fff' }}>{SHIPPING_STAGES[activeIndex]?.label || shippingStatus}</strong>.
            </Text>

            {/* 2. Mensaje condicional súper destacado para el retiro */}
...
// --- ESTILOS EN LÍNEA ---
const main = { backgroundColor: '#0a0a0a', fontFamily: '-apple-system,BlinkMacSystemFont,"Segoe UI",Roboto,Oxygen-Sans,Ubuntu,Cantarell,"Helvetica Neue",sans-serif', padding: '40px 0' };
...
// Estilos para la alerta de retiro
